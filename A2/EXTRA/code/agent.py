...
First, I made use of the existing compute_utility function.
Then, I accounted for moves that have a heavy absolute weight. I.E the corners (>0) and the pieces surrounding the corners (<0).
Finally, I looped over the board and checked which pieces occupy which position and inflicted a punishment or
reward on them depending on which position they occupy.
"""
